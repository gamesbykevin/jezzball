package com.gamesbykevin.jezzball.menu;

import com.gamesbykevin.jezzball.menu.layer.Instructions1;
import com.gamesbykevin.jezzball.menu.layer.Controls1;
import com.gamesbykevin.jezzball.menu.layer.NewGameConfirm;
import com.gamesbykevin.jezzball.menu.layer.Instructions2;
import com.gamesbykevin.jezzball.menu.layer.ExitGameConfirm;
...
import com.gamesbykevin.jezzball.menu.layer.NoFocus;
...
public class CustomMenu extends Menu
{
    ...
    //cheating meaning the balls dont move
    public static final int CHEAT_ENABLED = 1;
    ...
    public void update(final Engine engine) throws Exception
    {
        ...
        if (!super.hasFinished())
        {
            ...
            int soundIndex = -1, fullscreenIndex = -1, cheatIndex = -1;
            ...
            if (super.hasCurrent(LayerKey.Options))
            {
                ...
                cheatIndex      = getOptionSelectionIndex(LayerKey.Options, OptionKey.Cheat);
            }
            ...
            if (super.hasCurrent(LayerKey.OptionsInGame))
            {
                ...
                cheatIndex      = getOptionSelectionIndex(LayerKey.OptionsInGame, OptionKey.Cheat);
            }
            ...
            if (cheatIndex != NO_VALUE)
            {
                //make sure object exists first
                if (engine.getManager() != null && engine.getManager().getBallManager() != null)
                {
                    //turn cheat on or off
                    engine.getManager().getBallManager().setCheatEnabled(cheatIndex == CHEAT_ENABLED);
                }
                
                //make sure option setting is included in all Layers that use it
                setOptionSelectionIndex(OptionKey.Cheat, cheatIndex);
            }
